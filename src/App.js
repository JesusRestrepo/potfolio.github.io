    ...
    <div className="App">
      <ul className="nav nav-pills justify-content-end" id="pills-tab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
          <button  ref={miref} className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Contact</button>
        </li>
      </ul>
      <div className="tab-content" id="pills-tabContent">
        <div className="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab"> <Home title='home-page' onClick={onClick}></Home> </div>
